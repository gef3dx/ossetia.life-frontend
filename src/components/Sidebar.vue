...
<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="sidebar">
                            <!-- <div class="widget">
                                <h2 class="widget-title">Подпишись на нас в ВК</h2>
                                    <div id="vk_groups"></div>
                                    <script type="text/javascript">
                                      VK.Widgets.Group("vk_groups", {mode: 3, wide: 1, height: 400, color1: "FFFFFF", color2: "000000", color3: "000000"}, 116289196);
                                    </script>
                            </div> end widget -->
                        
                            <div class="widget">
                                <h2 class="widget-title">Радио Алания</h2>
                                <audio controls>
                                    <source src="https://vgtrk15.hostingradio.ru:8011/vgtrk15128.mp3" type="audio/ogg; codecs=vorbis">
                                    <source src="https://vgtrk15.hostingradio.ru:8011/vgtrk15128.mp3" type="audio/mpeg">
                              </audio>
                            </div><!-- end widget -->
                             ...
                             <div class="widget">
                                <div class="banner-spot clearfix">
                                    <div class="banner-img">
                                       <a href="https://it.ossetia.life" target="_blank">
